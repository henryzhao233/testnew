...
# 拉取插件请看《各种命令的简单介绍》第 4 条、第 5 条说明，不管大神还是新手请认真的看看，再次强调请不要一下子就拉取别人一堆插件的插件包，容易造成编译错误的
# git clone https://github.com/rufengsuixing/luci-app-autoipsetadder package/lean/luci-app-autoipsetadder #自动加入 ipset gfwlist
# git clone https://github.com/281677160/openwrt-passwall package/lean/openwrt-passwall
# git clone https://github.com/sirpdboy/luci-app-advanced package/lean/luci-app-advanced #高级设置
# git clone https://github.com/sbwml/luci-app-mosdns package/lean/openwrt-mos #DNS 转发分流
# git clone https://github.com/sbwml/v2ray-geodata package/lean/v2ray-geodata #DNS 转发分流数据库
...
sed -i "s/${orig_version}/R${date_version} by StarXu/g" package/lean/default-settings/files/zzz-default-settings
